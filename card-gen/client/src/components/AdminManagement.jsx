...
const AdminManagement = () => {
  ...
  return (
    <div className="p-6">
      ...
      {showCreateForm && (
        <div
          className="fixed inset-0 !mt-0 z-[9998] flex items-center justify-center bg-black/60 p-4"
          role="dialog"
          aria-modal="true"
          ...
          >
            <div className="px-6 py-4 border-b border-gray-100 flex items-start justify-between gap-4">
              <div className="min-w-0">
                <h2 id="admin-form-title" className="text-lg sm:text-xl font-semibold text-gray-900">
                  {editingAdmin ? 'Edit Admin' : 'Create New Admin'}
                </h2>
                <p className="text-xs text-gray-500 mt-1">
                  {editingAdmin
                    ? 'Update admin details. Password changes are handled separately.'
                    : 'Create a new admin with password and pricing.'}
                </p>
              </div>
              <button
                type="button"
                  ...
                  return (
                    <React.Fragment key={cat}>
                      ...
                      {group.length === 0 ? (
                        ...
                        group.map((admin) => (
                          <tr key={admin._id} className="hover:bg-gray-50 overflow-x-auto">
      ...
      {passwordModalAdmin && (
        <div
          className="fixed inset-0 !mt-0 z-[9998] flex items-center justify-center bg-black/50 p-4"
          role="dialog"
          aria-modal="true"
