    ...
    return (
        <div className="w-full max-w-md mx-auto bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
            ...
            <div className="p-5 space-y-5">
                ...
                <div className="bg-white rounded-[45px] p-4 border border-black">
                    ...
                    {!isHidden("aboutCompany") && cardData?.aboutCompany ? (
                        <div className="p-4">
                            <div className="text-xl text-center font-semibold text-black">About My Company</div>
                            <div className="mt-2 text-[10px] leading-[1.5] text-center text-black whitespace-pre-line">
                    ...
                    {!isHidden("founderMessage") && cardData?.founderMessage ? (
                        <div className={`rounded-3xl bg-white border border-black py-6 mt-4 px-6 ${!isHidden("vision") ? "mb-[-15px] relative z-10" : ""}`}>
                            <div className="text-base font-semibold text-black text-center mb-2">Founder Message</div>
                            <div className="text-[10px] leading-[1.5] text-black whitespace-pre-line">
                    ...
                    return (
                        <div className="mb-6 pt-4">
                            ...
                            {hasServices && (!showTabs || activeTab === "services") && (
                                <div className="flex flex-col gap-4 px-4 pb-8 pt-4 scrollbar-hide">
                                    {services.map((s, idx) => (
                                        <div
                                            key={idx}
                            ...
                            {hasProducts && (!showTabs || activeTab === "products") && (
                                <div className="flex overflow-x-auto scrollbar-hide gap-4 px-4 py-4">
                                    {products.map((p, idx) => (
                                        <div
                                            key={idx}
